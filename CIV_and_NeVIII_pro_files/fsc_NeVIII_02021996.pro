...
;
; PURPOSE:
;  To construct full sun 3D data cube from the slit scan of NE VIII [February 2, 1996] 
...
;  Last Modified: Alyssa Johnson 28 Jun 2021 
; 

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
pro fullsun_NeVIII_02021996

OpenW,lun,'fulldisk_NeVIII_02021996.txt',/Get_Lun	

rastor=fltarr(25,7500,7500)
rastor_step=0
ys0=0
ys=0
xs=0
...
fps=2
ovid=idlffvideowrite('fullsun_NEVIII_02021996.mp4')
...
for i= 0, count-1 do begin
    ...
    if abs(ys0-yss) ge 250 then begin
			...
			strip_no=strip_no+1
			window,xs=1000,ys=1000
			plot_image,sqrt(max(rastor,dimension=1)),title='Full Disk Peak Intensity in Ne VIII (February 2, 1996)', xtitle='arcseconds',ytitle='arcseconds'
      ...
      ;cursor,x,y	
		...
		if xs ne xss then rastor[0:24,yss:yss+299,xss]=data[0:24,60:359]
...
plot_image,sqrt(max(rastor,dimension=1)),title='Full Disk Peak Intensity in Ne VIII (February 2, 1996)', xtitle='arcseconds',ytitle='arcseconds',charsize=1.5
