...
for i= 3, count-1 do begin
    ...
    ;print,ys             
		...
		if xs ne xss then rastor[0,yss:yss+299,xs]=data[0,60:359];;;trial
...
window,xs=1000,ys=1000
plot_image,sqrt(peak_intensity)

;fullsun_NeVIII_06161996 = drive('fullsun_NeVIII_06161996.png')
;write_png, 'fullsun_NeVIII_06161996.png', TVRD(/TRUE)
;image2 = read_png(fullsun_NeVIII_06161996)

plot_image,sqrt(peak_intensity[0:2200,300:2500]),title='Full Disk Peak Intensity in Ne VIII (June 16, 1996)', xtitle='arcseconds',ytitle='arcseconds',charsize=1.5
write_png,'fullsun_NeVIII_06161996.png',tvrd(/true)
;stop
